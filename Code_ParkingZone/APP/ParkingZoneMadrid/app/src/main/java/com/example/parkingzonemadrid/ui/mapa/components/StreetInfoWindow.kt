...
class StreetInfoWindow(
    ...
    private val onNavigateClicked: (StreetZone) -> Unit
    ...
    fun bind(zone: StreetZone, favorite: Boolean) {
        ...
        val parkingTypeView = mView.findViewById<TextView>(R.id.iwParkingType)
        val favoriteBtn = mView.findViewById<ImageButton>(R.id.iwFavorite)
        val navigateBtn = mView.findViewById<MaterialButton>(R.id.iwNavigate)
        ...
        parkingTypeView.text = zone.parkingType.displayName
        ...
        navigateBtn.setOnClickListener {
            currentZone?.let { onNavigateClicked(it) }
        }
    }
